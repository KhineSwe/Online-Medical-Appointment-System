(function (a) {
	a.fn.webwidget_rating_simple = function (p) {
		...
		g.next("ul").children("li").hover(function () {
			$(this).parent().children("li").css('background-image', 'url(' + d + '/nst3.png)');
			var a = $(this).parent().children("li").index($(this));
			$(this).parent().children("li").slice(0, a + 1).css('background-image', 'url(' + d + '/sth3.png)')
		}, function () {});
		...
		g.next("ul").hover(function () {}, function () {
			if (f == "") {
				$(this).children("li").css('background-image', 'url(' + d + '/nst3.png)')
			} else {
				$(this).children("li").css('background-image', 'url(' + d + '/nst3.png)');
				$(this).children("li").slice(0, f).css('background-image', 'url(' + d + '/sth3.png)')
			}
		});
		function init() {
