...
<%@ include file="inc/calendar.jsp"%>
	...
	<div class="container">
		...
		<tr>
			<td></td>
			<th>${ScheduleFormBean.frmDocname.dname}'s schedule </th>
		</tr> --%>
					...
					<html:form action="/SearchByDate">
							...
							<td colspan="4">&nbsp;&nbsp;</td>
								...
								<tr>
								<td></td>
								<td colspan="2"><html:submit property="btnSearch" value="Search"
			...
			<!--  start dtrating -->
				<div id="dtrating" class="col-sm-12" align="center">
							...
							<table>
								...
								<tr>
									<td><html:textarea property="description"
											...
											styleClass="form-control" styleId="comment" disabled="true" style="resize: none;"/>
								</tr>
								<tr>
									<td><br /> <html:submit styleClass="btn btn-primary"
					...
					<c:if test="${ScheduleFormBean.appRate.pid==null }">
						<html:form action="/Rating">
							<div style="color: red;">
								<h4>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Please
									make an appointment first to give a rating!</h4>
							</div>
							<table>
								<tr>
					...
					<h4>
						<html:errors property="noRatingerror" />
					</h4>
					<c:if
						...
						<html:form action="/Rating">
							...
							<%
								String rate = (String) session.getAttribute("Urate");
							%>
							<%
								String des = (String) session.getAttribute("Udescription");
							%>
							<%
								int rate1 = Integer.parseInt(rate);
							%>
							<c:set var="myvalue" value="<%=rate1%>" scope="request" />
							<c:set var="mydes" value="<%=des%>" scope="request" />



							<table>
								<tr>
									<td><html:hidden property="rating" value="${myvalue}"
											styleId="rating_simple2" /></td>
								</tr>
								<tr>
									<td>&nbsp;</td>
								...
								<tr>
									<td><html:textarea property="description" value="${mydes}" styleClass="form-control" styleId="comment" disabled="true" style="resize: none;" /></td>
								</tr>
								<tr>
									<td><br /> <html:submit styleClass="btn btn-primary"
											disabled="true"> Rate </html:submit></td>
