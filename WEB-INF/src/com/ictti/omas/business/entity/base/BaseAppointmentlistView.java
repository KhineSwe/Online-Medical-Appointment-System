...
/**
 * This is an object that contains data related to the appointmentlist_view table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="appointmentlist_view"
 */

public abstract class BaseAppointmentlistView  implements Serializable {

	public static String REF = "AppointmentlistView";
	...
	// constructors
	public BaseAppointmentlistView () {
		initialize();
	}
	 ...
	 */
	public BaseAppointmentlistView (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.ictti.omas.business.entity.AppointmentlistView)) return false;
		else {
			com.ictti.omas.business.entity.AppointmentlistView appointmentlistView = (com.ictti.omas.business.entity.AppointmentlistView) obj;
			if (null == this.getId() || null == appointmentlistView.getId()) return false;
			else return (this.getId().equals(appointmentlistView.getId()));
		}
	}
