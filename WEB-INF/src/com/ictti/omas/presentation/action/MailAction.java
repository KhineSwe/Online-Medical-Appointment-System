...
import com.ictti.omas.presentation.form.ContactForm;
...
public class MailAction extends BaseAction {
	...
	protected String doExecute(ActionForm form, HttpServletRequest request,
		 ...
		 * System.out.println("To Login"); return "gotologin"; }
		 */
		System.out.println("Pid " + session.getAttribute("p_id"));
	...
	protected String doInit(ActionForm form, HttpServletRequest request,
		...
		if (session.getAttribute("p_id") != null) {
			...
			myForm.setFrmMailName("");
			myForm.setFrmMailNotiMessage("");
			System.out.println("wrong path 111");
			...
			myForm.setFrmMailName("");
			myForm.setFrmMailNotiMessage("");
			System.out.println("wrong path 222");
			return "gotoMailbeforelogin";
		}
	}
